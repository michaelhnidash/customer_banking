...
def main():
    ...
    savings_interest = float(input("Enter the annual interest rate (in percentage): "))
    ...
    cd_interest = float(input("Enter the annual interest rate for the CD (in percentage): "))
